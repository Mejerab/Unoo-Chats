    ...
    return (
        <div className="flex flex-col justify-center items-center w-full h-full gap-4">
            ...
            <form onSubmit={handleLogin} className="w-full text-center space-y-7">
                <input type="email" name="email" className="input w-full focus:border-0 focus:outline-0 input-bordered h-[56px] text-[#000000F2] placeholder:text-[#676767] rounded-xl font-medium" placeholder="Email Address" />
                <div className="relative">
                    <input type={show ? 'text' : 'password'} name="password" className="input w-full relative focus:border-0 focus:outline-0 input-bordered h-[56px] text-[#000000F2] placeholder:text-[#676767] rounded-xl font-medium" placeholder="Password" />
                ...
                {user ? <div className="tooltip w-full" disabled data-tip="You are already logged in !">
                    ...
                    loadi ? <button disabled className="btn overflow-hidden button relative hover:text-white text-black rounded-full h-[50px] w-full !bg-white"><span className="z-20 loading loading-spinner text-[#8b5cf6] loading-xl"></span></button> :
                        <button onClick={() => setLoadi(true)} className="btn overflow-hidden button relative hover:text-white text-black rounded-full h-[50px] w-full"><span className="z-20">Login</span></button>
                }
            </form>
